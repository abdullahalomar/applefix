  ...
  return (
    <Container className="my-40">
      ...
      <div className="grid grid-cols-12 gap-[20px]">
        ...
        <div className="bg-red-300 h-[415px] rounded-2xl col-span-12"></div>
        <div className="bg-red-300 h-[415px] rounded-2xl col-span-12 md:col-span-6 lg:col-span-4"></div>
        <div className="bg-red-300 h-[415px] rounded-2xl col-span-12 md:col-span-6 lg:col-span-4"></div>
        <div className="bg-red-300 h-[415px] rounded-2xl col-span-12 md:col-span-12 lg:col-span-4"></div>
      </div>
    </Container>
  );
};
